"""
Object Detection for HowYouSeeMe
YOLO-based object detection with resource management
"""
...
class YOLODetector:
    """YOLO object detector with resource management"""
    ...
    def __init__(self, model_name: str = "yolov5s", confidence_threshold: float = 0.5,
        ...
        logger.info(f"YOLODetector initialized for {model_name} on {self.device}")
